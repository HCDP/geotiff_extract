...
def get_index_value(file, index):
    with open(file, "rb") as f:
        ...
        val_start = col * 4
        print("bytes: ", strip[val_start:val_start + 4])
...
val = get_index_value("rainfall_new_month_statewide_data_map_2023_02.tif", 0)
print(val)
